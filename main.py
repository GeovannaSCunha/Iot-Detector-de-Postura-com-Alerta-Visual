...
# Configurações
LIMIAR_INCLINACAO = 0.08  # Ajuste este valor (0.05 a 0.15)
...
while True:
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            nariz = [pontos[1].x, pontos[1].y]  # Landmark 1
            queixo = [pontos[152].x, pontos[152].y]  # Landmark 15
    ...
    cv2.imshow("Detector de Postura Simplificado", frame)
